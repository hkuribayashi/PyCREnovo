...
for i in range(simulacoes):
    ...
    path = os.path.join(GlobalConfig.DEFAULT.base_path, "models", "ppo_0.zip")
    if os.path.isfile(path):
        ...
        model = PPO("MlpPolicy", env, verbose=2, policy_kwargs=dict(optimizer_class=RMSpropTFLike,
    ...
    if i == 9:
        coletar_satisfacao('PPO_media', media_satisfaction)
