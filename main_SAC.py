...
for i in range(simulacoes):
    ...
    path = os.path.join(GlobalConfig.DEFAULT.base_path, "models", "SAC_0.zip")
    if os.path.isfile(path):
        ...
        model = SAC("MlpPolicy", env, verbose=2, policy_kwargs=dict(optimizer_class=RMSpropTFLike,
    ...
    if i == 9:
        coletar_satisfacao('SAC_media', media_satisfaction)
